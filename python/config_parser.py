# Android FinFisher DexDen configuration parser
# Esther Onfroy a.k.a U+039b - *@0x39b.fr (https://twitter.com/u039b)
#
# Automatically extract FinSpy configuration stored in DEX (DexDen only).
...
def find_config_entry(dex):
    ...
    second_marker = 8663968  # TlvTypeMobileTargetOfflineConfig

    while i < len(dex) - 12:
        marker_1 = struct.unpack_from('<I', dex, i)[0]
...
def get_tlv_name(tlv):
    if tlv not in tlv_types.keys():
        return 'Unknown'
